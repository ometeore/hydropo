...
def reset_password(request):
    return render(request, 'message/error.html', {'issue': "Not available yet. Contact admin."})
...
def rpi_create(request):
    ...
    if form.is_valid():
        ...
        rpi.uid_name = id(rpi)
        rpi.is_conected = False
        rpi.last_connect = datetime(2013, 11, 20, 20, 8, 7, 127325, tzinfo=pytz.UTC)
        rpi.save()
        print("rpi save")
